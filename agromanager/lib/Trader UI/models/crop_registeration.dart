...
class CropRegister extends StatefulWidget {
  const CropRegister({Key? key}) : super(key: key);

  @override
  _CropRegisterState createState() => _CropRegisterState();
}

class _CropRegisterState extends State<CropRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    final descriptionField = TextFormField(
        ...
        validator: (value) {
          if (value!.isEmpty) {
            return (" Description of Crop Cannot be Empty");
          }
          return null;
        },
        onSaved: (value) {
