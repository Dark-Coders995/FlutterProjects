...
class CropRabiScreen extends StatefulWidget {
  final Rabi crop;

  const CropRabiScreen({Key? key, required this.crop}) : super(key: key);

  @override
  _CropRabiScreenState createState() => _CropRabiScreenState();
}

class _CropRabiScreenState extends State<CropRabiScreen> {
  @override
