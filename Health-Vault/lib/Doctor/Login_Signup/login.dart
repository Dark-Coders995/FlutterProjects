...
import 'package:health_vault/Doctor/Login_Signup/signup.dart';
import 'package:health_vault/Doctor/Pages/first_page.dart';

class LoginScreenDoc extends StatefulWidget {
  const LoginScreenDoc({Key? key}) : super(key: key);

  @override
  _LoginScreenDocState createState() => _LoginScreenDocState();
}
